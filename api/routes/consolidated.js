...
const handleData = async (req, res, tableName) => {
    try {
        if (supabaseServer) {
            switch (req.method) {
                case 'GET':
...
// Data routes
router.get('/normas', (req, res) => handleData(req, res, 'normas'));
router.post('/normas', (req, res) => handleData(req, res, 'normas'));
router.get('/ouvidoria', (req, res) => handleData(req, res, 'manifestacoes'));
router.post('/ouvidoria', (req, res) => handleData(req, res, 'manifestacoes'));
router.get('/auditorias', (req, res) => handleData(req, res, 'auditorias'));
router.post('/auditorias', (req, res) => handleData(req, res, 'auditorias'));
router.get('/disciplinar', (req, res) => handleData(req, res, 'processos_disciplinares'));
router.post('/disciplinar', (req, res) => handleData(req, res, 'processos_disciplinares'));
router.get('/transparencia', (req, res) => handleData(req, res, 'publicacoes'));
router.post('/transparencia', (req, res) => handleData(req, res, 'publicacoes'));
// IA routes
router.post('/ia/contratos', async (req, res) => {
...
router.post('/ia/parcerias', async (req, res) => {
    const { texto } = req.body;
    if (!texto) {
        res.status(400).json({ success: false, error: 'Texto é obrigatório' });
        return;
...
// Orçamento routes
router.get('/orcamento/execucao/:ano', (req, res) => {
